...
<p align="center">
  <img src="assets/paper-preview.png" alt="s1-Test-Time-Scaling-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2501.19393). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | Reasoning / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for s1: Simple test-time scaling, focusing on simple test-time scaling and budget forcing for mathematical reasoning. The code... |
